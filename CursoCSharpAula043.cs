// AULA 043 - https://youtu.be/NSjz4HS7bPU?list=PLx4x_zx8csUglgKTmgfVFEhWWBQCasNGi
// Interfaces
...
// toda classe que implementar uma interface ela precisa implementar seus metodos...
// interface não pode ter construtor nem destrutor...
// não pode ser static
// Interface só poderá ter as assinaturas dos métodos...
// Declarar a Interface Veiculo043
public interface Veiculo043 {
...
// Declarar a Interface Veiculo043
public interface Combate043 {
  // deverá implementar os seguintes métodos...
  void disparar();
}

// Classe Carro043 implementa a Interface Veiculo043
class Carro043 : Veiculo043, Combate043 {
  // propriedades...
  private bool ligado;
  private int municao;
  ...
  public void info() {
    Console.WriteLine("x--------------------------------------------------");
    Console.WriteLine("Ligar {0}", this.ligado);
    
    Console.WriteLine("Disparar {0}", this.municao);
    Console.WriteLine("x--------------------------------------------------");
  }

// AULA 058 - https://youtu.be/Saa1IPQD0KA?list=PLx4x_zx8csUglgKTmgfVFEhWWBQCasNGi
// Coleção List P2 - coleção mais moderna... um array dinamico, tunado...
...
class PrincipalAula058 {
  ...
  static void Main(string[] args) { // lista de argumentos do programa...
    ...
    //carros.RemoveAt(0); // posição zero...
   ...
   // pesquisa um elemento especifico...
    ...
    pos = carros.LastIndexOf("HRV");
    Console.WriteLine("Último HRV está na posição {0}", pos);
